...
* **Docs sites**\
  Toggle this section to view all the [docs sites](../publish-a-docs-site/) in your organization right in the sidebar and jump to one with a click.
* **Spaces**\
...
With [page options](../customization/page-layouts.md), you to customize your documentation layout and navigation. You can only access page options if you’re in an editing mode.
